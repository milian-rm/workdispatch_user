...
router.get('/client/:clientId', getReviewsValidator, getClientReviews);
router.put('/:id', editReviewValidator, editReview);
router.get('/worker/:workerId', getReviewsValidator, getWorkerReviews);
